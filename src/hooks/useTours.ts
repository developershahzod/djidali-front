...
const convertApiTourToTour = (apiTour: ApiTour): Tour => {
  const priceValue = typeof apiTour.price === 'object' ? (apiTour.price.uzs || apiTour.price.UZS || apiTour.price.amount || 250) : (typeof apiTour.price === 'number' ? apiTour.price : 250);
