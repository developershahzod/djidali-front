              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-4 text-gray-600">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-sm">{tour.duration} дней</span>
                  </div>
                  <div className="flex items-center gap-1">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-8">
                    <div className="col-span-2 relative group">
                      <img
                        src={images[0]}
                        alt="Main tour image"
                        className="w-full h-96 object-cover rounded-2xl cursor-pointer shadow-md"
                      />
                      {images.length > 1 && (
                        <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-semibold shadow-lg">
                ...
                <div className="bg-gray-50 rounded-2xl p-8 mb-8">
                  ...
                  <div className="grid grid-cols-3 gap-6 mb-6">
                    ...
                    <div className="text-center">
                      ...
                      <h3 className="font-bold text-gray-900 mb-1">Легкое</h3>
                      <p className="text-sm text-gray-600">Тип тура</p>
                    </div>
                  </div>
                </div>
