...
const CategoryPage: React.FC = () => {
  ...
  const { category, loading: categoryLoading } = useCategoryBySlug(categorySlug || null);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">{tours.length} ta tur topildi</p>
            </div>
            ...
            <>
              ...
              {tours.length === 0 && (
                <div className="text-center py-12">
                  <div className="text-gray-500 text-lg mb-2">Turlar topilmadi</div>
                  <div className="text-gray-400 text-sm">Boshqa kategoriyani sinab ko'ring</div>
                </div>
              )}
            </>
          )}
