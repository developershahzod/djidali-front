    ...
    <div className="min-h-screen bg-gray-50">
      <div className="relative h-[200px] bg-gradient-to-br from-gray-100 to-gray-200">
        ...
        <div className="absolute top-4 right-8 text-right">
          ...
          <div className="text-2xl font-bold text-gray-900">(+610) 818-1215</div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-2 gap-12 mb-20">
          ...
          >
            <div className="bg-gradient-to-t from-black/60 to-transparent h-full flex flex-col justify-end p-8">
              <h3 className="text-3xl font-bold text-white mb-2">Путешествие<br />по Дальверзину</h3>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-20">
          ...
          <div>
            ...
            <div className="text-4xl font-bold text-gray-900">Support@balcom.com</div>
          </div>
        </div>
