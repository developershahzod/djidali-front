  ...
  return (
    <footer className="relative bg-white w-full min-h-[671px] lg:h-[671px]">
      <div className="relative max-w-[1440px] mx-auto h-full px-[20px] md:px-[50px] py-[30px] lg:py-0">
        ...
        >
          {translate({ ru: 'Связаться с нами', uz: 'Biz bilan bog\'lanish', en: 'Contact us', de: 'Kontaktiere uns' })}
        </p>
        ...
        <p 
          ...
          style={{ fontFamily: 'Montserrat, sans-serif' }}
        >
          {translate({ ru: 'Разделы сайта', uz: 'Sayt bo\'limlari', en: 'Site sections', de: 'Website-Bereiche' })}
        </p>
        ...
        <p
          ...
          style={{ fontFamily: 'Montserrat, sans-serif' }}
        >
          {translate({ ru: 'Социальные сети', uz: 'Ijtimoiy tarmoqlar', en: 'Social networks', de: 'Soziale Netzwerke' })}
        </p>
        ...
        <div className="lg:absolute lg:left-[50px] lg:top-[291px] grid grid-cols-1 md:grid-cols-2 lg:flex lg:items-start gap-6 md:gap-8 lg:gap-[65px] mb-8 lg:mb-0">
          ...
          <div className="flex flex-col gap-[10px] w-full lg:w-[257px]">
            <p 
              ...
              style={{ fontFamily: 'Montserrat, sans-serif' }}
            >
              {translate({ ru: 'О нас', uz: 'Biz haqimizda', en: 'About us', de: 'Über uns' })}
            </p>
            <div className="flex flex-col gap-[8px]">
              ...
              <button
                ...
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                {translate({ ru: 'Интересное', uz: 'Qiziqarli', en: 'Interesting', de: 'Interessant' })}
              </button>
              <button
                ...
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                {translate({ ru: 'Команда', uz: 'Jamoa', en: 'Team', de: 'Team' })}
              </button>
              <button
                ...
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                {translate({ ru: 'Галерея', uz: 'Galereya', en: 'Gallery', de: 'Galerie' })}
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-[10px] w-full lg:w-[257px]">
            <p 
              ...
              style={{ fontFamily: 'Montserrat, sans-serif' }}
            >
              {translate({ ru: 'Виды туризма', uz: 'Turizm turlari', en: 'Tourism types', de: 'Tourismus-Arten' })}
            </p>
            <div className="flex flex-col gap-[8px]">
              <button
                ...
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                {translate({ ru: 'Экотуризм', uz: 'Ekoturizm', en: 'Ecotourism', de: 'Ökotourismus' })}
              </button>
              <button
                ...
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                {translate({ ru: 'Агротуризм', uz: 'Agroturizm', en: 'Agrotourism', de: 'Agrotourismus' })}
              </button>
              <button
                ...
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                {translate({ ru: 'Тимбилдинг', uz: 'Jamoa qurish', en: 'Team building', de: 'Teambuilding' })}
              </button>
              <button
                ...
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                {translate({ ru: 'Спортивная стрельба', uz: 'Sport otish', en: 'Sport shooting', de: 'Sportschießen' })}
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-[10px] w-full lg:w-[257px]">
            <p 
              ...
              style={{ fontFamily: 'Montserrat, sans-serif' }}
            >
              {translate({ ru: 'Наши туры', uz: 'Bizning turlar', en: 'Our tours', de: 'Unsere Touren' })}
            </p>
            <div className="flex flex-col gap-[8px]">
              <button
                ...
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                {translate({ ru: 'Индивидуальные туры', uz: 'Individual turlar', en: 'Individual tours', de: 'Individuelle Touren' })}
              </button>
              <button
                ...
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                {translate({ ru: 'Групповые туры', uz: 'Guruh turlari', en: 'Group tours', de: 'Gruppentouren' })}
              </button>
              <button
                ...
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                {translate({ ru: 'Семейные туры', uz: 'Oilaviy turlar', en: 'Family tours', de: 'Familientouren' })}
              </button>
              <button
                ...
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
                {translate({ ru: 'Корпоративные туры', uz: 'Korporativ turlar', en: 'Corporate tours', de: 'Firmentouren' })}
              </button>
            </div>
          </div>
        </div>
        ...
        >
          <p 
            ...
            style={{ fontFamily: 'Montserrat, sans-serif' }}
          >
            {translate({ ru: 'Наши контакты', uz: 'Bizning kontaktlar', en: 'Our contacts', de: 'Unsere Kontakte' })}
          </p>
          <svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="lg:w-[32px] lg:h-[32px] text-[#333333] group-hover:text-[#8F7B49] transition-colors">
            <path d="M6.66669 16H25.3334" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M18.6667 9.33301L25.3334 16L18.6667 22.6663" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
