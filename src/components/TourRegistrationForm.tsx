...
const TourRegistrationForm: React.FC<TourRegistrationFormProps> = ({ tour, isOpen, onClose }) => {
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center transform transition-all">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-3">Tizimga kirish talab qilinadi</h2>
          <p className="text-gray-600 text-lg mb-8">
            Buyurtma berish uchun avval tizimga kirishingiz yoki ro'yxatdan o'tishingiz kerak.
          </p>
  ...
  const tourPrice = (typeof tour.price === 'object' && tour.price?.amount) || (typeof tour.price === 'number' ? tour.price : 0);
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center transform transition-all">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-3">Muvaffaqiyatli!</h2>
          <p className="text-gray-600 text-lg mb-8">
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50 overflow-y-auto">
        ...
        <div className="relative bg-gradient-to-r from-emerald-500 to-green-600 rounded-t-2xl px-8 py-6">
          ...
          <p className="text-white/90 text-sm">Quyidagi ma'lumotlarni to'ldiring</p>
        </div>
        ...
        <div className="px-8 py-6 bg-gradient-to-br from-gray-50 to-gray-100 border-b border-gray-200">
          <div className="flex items-start space-x-4">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 mb-2">{tour.destination} • {tour.duration} kun</p>
        ...
        <form onSubmit={handleSubmit} className="px-8 py-6 space-y-6">
          ...
          <div className="bg-gradient-to-br from-emerald-50 to-green-50 border-2 border-emerald-200 rounded-xl p-6">
            <div className="flex justify-between items-center mb-3">
              ...
              <span className="font-semibold text-gray-900">{tourPrice.toLocaleString()} UZS</span>
            </div>
            <div className="flex justify-between items-center mb-3">
              <span className="text-gray-700 font-medium">Ishtirokchilar:</span>
              <span className="font-semibold text-gray-900">{participants} kishi</span>
            </div>
          ...
          <p className="text-xs text-gray-500 text-center">
            Buyurtmangizni yuborish orqali siz <a href="#" className="text-emerald-600 hover:underline">shartlar va qoidalar</a> bilan rozisiz
          </p>
        </form>
      </div>
    </div>
