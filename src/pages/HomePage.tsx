    ...
    <div className="bg-[#F5F1E6] text-[#2A241C]">
      ...
      <section id="why-us" className="w-full pt-0 pb-0">
        ...
        <div className="relative w-full h-[clamp(1000px,111.11vw,1600px)] mx-auto hidden lg:block">
          ...
          <div className="absolute left-0 top-0 w-[50%] h-[clamp(280px,31.25vw,450px)] bg-[#8F7B49]" aria-label="Why Us Section">
            {/* Icon */}
          ...
          <div className="absolute left-0 top-[clamp(280px,31.25vw,450px)] w-[50%] h-[clamp(280px,31.25vw,450px)] overflow-hidden" style={{ backgroundImage: 'url(/why-us-nature.webp)', backgroundSize: 'cover', backgroundPosition: 'center top' }}>
          ...
          <div className="absolute left-0 top-[clamp(560px,62.5vw,900px)] w-[48.96%] h-[clamp(440px,48.61vw,700px)] overflow-hidden" style={{ backgroundImage: 'url(/why-us-comfort.webp)', backgroundSize: 'cover', backgroundPosition: 'center center' }}>
            <div className="absolute inset-0 bg-gradient-to-b from-[rgba(0,0,0,0.45)] to-transparent"></div>
          ...
          <div className="absolute right-0 top-0 w-[51.04%] h-[clamp(560px,62.5vw,900px)] overflow-hidden" style={{ backgroundImage: 'url(/why-us-team.webp)', backgroundSize: 'cover', backgroundPosition: 'center center' }}>
            <div className="absolute inset-0 bg-gradient-to-b from-[rgba(0,0,0,0.45)] to-transparent"></div>
          ...
          <div className="absolute right-0 top-[clamp(560px,62.5vw,900px)] w-[51.04%] h-[clamp(440px,48.61vw,700px)] overflow-hidden" style={{ backgroundImage: 'url(/why-us-routes.webp)', backgroundSize: 'cover', backgroundPosition: 'center center' }}>
            <div className="absolute inset-0 bg-gradient-to-b from-[rgba(0,0,0,0.45)] to-transparent"></div>
