        ...
        <div className="max-w-[min(1440px,100vw)] mx-auto px-[clamp(20px,3.47vw,50px)]">
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-[clamp(40px,6.94vw,100px)] gap-4">
            ...
            <p className="font-light leading-[1.4] text-[clamp(16px,1.39vw,20px)] tracking-[-0.02em] text-[#333333]" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              {t('home.popular.subtitle').replace('{count}', String(pagination?.total || tours.length))}
            </p>
          </div>
      ...
      <section id="why-us" className="w-full pt-0 pb-0">
        ...
        <div className="relative w-full h-[clamp(1000px,111.11vw,1600px)] mx-auto hidden lg:block">
          ...
          <div 
            ...
            style={{ backgroundImage: 'url(/why-us-nature.webp)', backgroundSize: 'cover', backgroundPosition: 'center top' }}
            role="button"
            tabIndex={0}
            onKeyDown={(e) => {
              if (e.key === 'Enter' || e.key === ' ') {
          ...
          <div 
            ...
            style={{ backgroundImage: 'url(/why-us-comfort.webp)', backgroundSize: 'cover', backgroundPosition: 'center center' }}
            role="button"
            tabIndex={0}
            onKeyDown={(e) => {
              if (e.key === 'Enter' || e.key === ' ') {
          ...
          <div 
            ...
            style={{ backgroundImage: 'url(/why-us-team.webp)', backgroundSize: 'cover', backgroundPosition: 'center center' }}
            role="button"
            tabIndex={0}
            onKeyDown={(e) => {
              if (e.key === 'Enter' || e.key === ' ') {
          ...
          <div 
            ...
            style={{ backgroundImage: 'url(/why-us-routes.webp)', backgroundSize: 'cover', backgroundPosition: 'center center' }}
            role="button"
            tabIndex={0}
            onKeyDown={(e) => {
              if (e.key === 'Enter' || e.key === ' ') {
