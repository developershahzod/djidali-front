...
interface TourEditModalProps {
  ...
  t: (key: string) => string;
  getTranslated: (text: string | { [key: string]: string } | undefined) => string;
  ...
  updateArrayField: (field: 'inclusions' | 'exclusions', index: number, lang: 'uz' | 'ru' | 'eng' | 'de', value: string) => void;
  removeArrayField: (field: 'inclusions' | 'exclusions', index: number) => void;
  addItineraryStep: () => void;
  updateItineraryStep: (index: number, field: keyof ItineraryStep, value: string) => void;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setTourFormData({ ...tourFormData, status: e.target.value as TourFormState['status'] })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                >
            ...
            <div className="space-y-4">
              ...
              {(tourFormData.images.length > 0 || previewImages.length > 0) && (
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                  {[...tourFormData.images, ...previewImages.slice(tourFormData.images.length)].map((image, index) => (
                  ...
                  <div className="space-y-3 p-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateItineraryStep(index, `title${activeLangTab.charAt(0).toUpperCase() + activeLangTab.slice(1)}` as keyof ItineraryStep, e.target.value)}
                    ...
                    <textarea
                      ...
                      onChange={(e) => updateItineraryStep(index, `description${activeLangTab.charAt(0).toUpperCase() + activeLangTab.slice(1)}` as keyof ItineraryStep, e.target.value)}
                      rows={3}
