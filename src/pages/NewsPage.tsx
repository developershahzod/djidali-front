...
export const getLocalizedNewsData = (
  language: "ru" | "uz" | "en" | "de" = "ru",
) => {
...
function Logo() {
  return (
    <div
      className="overflow-clip relative shrink-0 size-[54px]"
      data-name="Logo"
    >
      <Group />
    </div>
...
function Frame3() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#333333] text-[14px] text-nowrap uppercase whitespace-pre">
        РУ
      </p>
      <Frame />
    </div>
...
function Button() {
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="absolute border border-[#333333] border-solid inset-0 pointer-events-none rounded-[100px]"
      />
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[16px] relative shrink-0 text-[#333333] text-[14px] text-nowrap uppercase whitespace-pre">
        Забронировать
      </p>
    </div>
  );
...
function NavItems() {
  return (
    <div
      className="absolute content-stretch flex items-center left-[calc(50%+0.5px)] top-1/2 translate-x-[-50%] translate-y-[-50%]"
      data-name="Nav Items"
    >
      <NavItem />
      <NavItem1 />
...
function NavContent() {
  return (
    <div
      className="backdrop-blur-sm backdrop-filter basis-0 bg-[rgba(51,51,51,0.1)] grow max-w-[1680px] min-h-px min-w-px relative rounded-[16px] shrink-0"
...
function _Nav() {
  return (
    <div
      className="absolute box-border content-stretch flex items-center justify-between left-0 pb-0 pt-[20px] px-[50px] right-0 top-0"
      data-name="Nav"
    >
      <NavContent />
    </div>
...
function Hero({ searchQuery, onSearchChange, newsCount }: HeroProps) {
  ...
  return (
    <div className="relative h-[500px] md:h-[600px] lg:h-[700px] w-full overflow-hidden">
      ...
      {/* Decorative line */}
      <div className="hidden md:block absolute h-0 left-[80px] md:left-[120px] top-[320px] md:top-[357px] w-[60px] md:w-[100px]"></div>
      ...
      <div className="absolute left-[20px] md:left-[50px] right-[20px] md:right-auto top-[280px] md:top-[380px] lg:top-[466px] flex flex-col md:flex-row gap-[10px] md:w-auto lg:w-[1340px]">
        ...
        <button className="bg-[#8f7b49] hover:bg-[#7a6839] h-[60px] md:h-[80px] w-full md:w-[180px] rounded-[10px] flex items-center justify-center transition-colors">
          <p className="font-['Montserrat:Bold',sans-serif] font-bold text-[18px] md:text-[20px] text-white tracking-[-0.36px] md:tracking-[-0.4px]">
            {translate({
              ru: "Поиск",
              uz: "Qidiruv",
              en: "Search",
        ...
        {filteredNews.length > 0 ? (
          <div className="flex flex-col gap-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-4 md:gap-6">
              ...
              {/* Small Card */}
              {filteredNews[1] && <NewsCard item={filteredNews[1]} />}
            </div>
