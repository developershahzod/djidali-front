    ...
    <div className="bg-[#f4f2ed]">
      ...
      <header className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img alt="" className="w-full h-full object-cover" src="../public/9f3c2fb5c6869a8e4518c822f8f17c270cf7775c.jpg" />
      ...
      <section className="bg-white">
        <div className="flex max-w-[100vw]">
          ...
          <div className="flex-1 min-h-[clamp(600px,62.5vw,900px)]">
            <img alt="" className="w-full h-full object-cover" src="../public/277314ef62dc41f8ef3db3163f88bc59e7fd0665.jpg" />
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-[clamp(60px,6.25vw,90px)]">
        <div className="max-w-[min(1440px,90vw)] mx-auto px-[clamp(30px,3.47vw,50px)]">
          <h2
            className="text-[clamp(40px,4.17vw,60px)] font-medium leading-[1] text-[#333333] tracking-[-0.03em] mb-[clamp(30px,2.78vw,40px)]"
            style={{ fontFamily: 'Montserrat, sans-serif' }}
          >
            Почему мы
          </h2>
          <div className="flex flex-col gap-[clamp(20px,1.94vw,28px)]">
            <p
              className="text-[clamp(18px,1.67vw,24px)] font-normal leading-[1.67] text-[#333333] tracking-[-0.02em]"
              style={{ fontFamily: 'Montserrat, sans-serif' }}
            >
              Мы создаем условия для вашего комфорта, предлагая современные решения, безопасную среду и продуманную инфраструктуру для жизни и работы.
            </p>
            <p
              className="text-[clamp(16px,1.39vw,20px)] font-light leading-[1.75] text-[#333333] tracking-[-0.02em]"
              style={{ fontFamily: 'Montserrat, sans-serif' }}
            >
              Наши преимущества включают комфортное проживание с высококлассным сервисом, тщательно спланированные маршруты и профессиональную команду, которая заботится о каждой детали вашего путешествия.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#f4f2ed] py-[clamp(30px,3.47vw,50px)]">
        <div className="max-w-[min(1440px,90vw)] mx-auto px-[clamp(30px,3.47vw,50px)]">
          <div className="relative aspect-[2.06/1] rounded-[clamp(12px,1.39vw,20px)] overflow-hidden">
            <img alt="" className="w-full h-full object-cover" src="../public/dc3d98eef0e770b0733e6c1cac8c4f9c3f97c42e.png" />
      ...
      <section className="bg-[#b4a785]">
        <div className="flex max-w-[100vw]">
          ...
          <div className="flex-1 min-h-[clamp(450px,45.14vw,650px)]">
            <img alt="" className="w-full h-full object-cover" src="../public/5387d8305f0288a181dcfb04206fd011f63fa6e1.jpg" />
          </div>
