...
const WishlistPage: React.FC = () => {
  ...
  const handleClearWishlist = async () => {
    const confirmed = await confirm({
      ...
      message:
        t("wishlist.clearAllConfirm") ||
        "Are you sure you want to clear all items from your wishlist?",
      confirmText: t("wishlist.clearAll") || "Clear All",
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    {wishlistItems.length} {t("wishlist.saved")}
                  </p>
                </div>
              </div>
            </div>
        ...
        {wishlistItems.length > 0 ? (
          <>
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="text-sm text-gray-600">
                {t("wishlist.showing")} {wishlistItems.length}{" "}
                {t("wishlist.of")} {wishlistItems.length}
              </div>
            </div>
          ...
          <div className="text-center py-16">
            ...
            <div className="space-y-4">
              ...
              <div className="text-sm text-gray-500">{t("wishlist.tip")}</div>
            </div>
          </div>
        )}
      </div>
