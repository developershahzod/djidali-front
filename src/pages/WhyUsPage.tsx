...
const WhyUsPage: React.FC = () => {
  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      const validCategories: CategoryType[] = ['routes', 'nature', 'comfort', 'team'];
  ...
  useEffect(() => {
    if (categoryNavRef.current) {
      const offset = 80;
      const elementPosition = categoryNavRef.current.getBoundingClientRect().top + window.pageYOffset;
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F0] text-[#1C160D]">
      ...
      {/* Category Navigation */}
      <section ref={categoryNavRef} className="bg-[#F5F5F0] mt-[80px] px-[50px]">
        <div className="flex items-center h-[80px] max-w-[1340px] mx-auto">
          ...
          >
            <p 
              ...
              style={{ fontFamily: 'Montserrat, sans-serif', letterSpacing: '-0.44px' }}
              dangerouslySetInnerHTML={{ __html: t('whyUs.categories.routes').replace(/\n/g, '<br />') }}
            />
          </button>
          {/* Знакомство с первозданной природой */}
          <button
          ...
          >
            <p 
              ...
              style={{ fontFamily: 'Montserrat, sans-serif', letterSpacing: '-0.44px' }}
              dangerouslySetInnerHTML={{ __html: t('whyUs.categories.nature').replace(/\n/g, '<br />') }}
            />
          </button>
          {/* Комфортное проживание */}
          <button
          ...
          >
            <p 
              ...
              style={{ fontFamily: 'Montserrat, sans-serif', letterSpacing: '-0.44px' }}
              dangerouslySetInnerHTML={{ __html: t('whyUs.categories.comfort').replace(/\n/g, '<br />') }}
            />
          </button>
          {/* Команда специалистов */}
          <button
          ...
          >
            <p 
              ...
              style={{ fontFamily: 'Montserrat, sans-serif', letterSpacing: '-0.44px' }}
              dangerouslySetInnerHTML={{ __html: t('whyUs.categories.team').replace(/\n/g, '<br />') }}
            />
          </button>
        </div>
      </section>
